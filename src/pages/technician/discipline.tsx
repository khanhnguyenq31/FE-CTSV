...
function EvaluationDraftsTab({ messageApi }: { messageApi: any }) {
    ...
    uniqueMajors.sort((first, second) => first.localeCompare(second, 'vi', { sensitivity: 'base' }));
    ...
    uniqueCohorts.sort((first, second) => first.localeCompare(second, 'vi', { sensitivity: 'base' }));
