...
import { Input, Button, Form, message as antdMessage, Card, Typography } from "antd";
            ...
            >
              ...
              <div className="flex justify-between items-center text-sm mt-2">
                <a
                  ...
                  onClick={() => messageApi.info("Chức năng Quên mật khẩu")}
                >
                  Quên mật khẩu?
                </a>
                <a
                  className="text-black underline hover:opacity-80"
                  onClick={() => messageApi.info("Chuyển tới Đăng ký")}
                >
                  Đăng ký tài khoản
                </a>
              </div>
