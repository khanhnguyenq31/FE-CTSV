  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-0">
      ...
      <div className="px-6 pt-6 pb-0">
        <h2 className="font-bold text-xl mb-4">Quản lý tài khoản sinh viên</h2>
        <Row gutter={16} style={{ marginBottom: 24 }}>
          <Col span={8}>
            <Card bordered={false} style={{ background: '#e6f7ff' }}>
              <div className="font-bold text-lg">Tổng số sinh viên</div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <h2 className="font-bold text-xl">Danh sách sinh viên</h2>
